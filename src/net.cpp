...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DGcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dgcointools.com", "dnsseed.dgcointools.com"},
    {"dgcoinpool.org", "dnsseed.dgcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"dgcointools.com", "testnet-seed.dgcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DGcoin is probably already running."), addrBind.ToString().c_str());
        else
